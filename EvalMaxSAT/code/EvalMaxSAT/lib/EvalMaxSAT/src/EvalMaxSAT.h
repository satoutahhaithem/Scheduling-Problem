...
class EvalMaxSAT {
    ...
    ///
        ...
        std::map<t_weight, std::set<int>> _mapWeight2Assum; // _mapWeight2Assum[weight] = set of literals with this weight // TODO: use a vector instead of a set (setctor)
        t_weight cost = 0;
...
public:
    ...
    bool solve() {
        ...
        // TODO: Perform the incomplete solve here rather than making a system call.

        // TODO: Add incremental solve
